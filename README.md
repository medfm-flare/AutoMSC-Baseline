...
Package a trained baseline as a FLARE-style Docker image that runs joint segmentation +
classification on a folder of test cases. The image follows the standard test protocol:
